public class WorkGit {
    ...
    */
    ...
    Если мы сдеелали в файле какие-то изменения, то их можно сохранить, условно говоря, в черновике.
    А для этого необходимо нажать на Shelf, и все наши изменения спрячутся. А посмотреть их можно
    будет, также нажав на вкладку Shelf. Чтобы вернуть данные из черновика к нам в файл, нужно
    также нажать на кнопку anShelf. Также данные файлы можно найти, нажав на корневую папку
    нашего проекта just_simple_project -- Open in -- Explorer -- .idea -- shelf.
    Если в проекте данные файлы пропали, то в разделе Shelf -- ПКМ -- Import Patches
